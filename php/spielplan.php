...
<!--     <form method="get" action="tippen.php" id="formSort" style="display: block;height: 100px;">
    ...
    <form method="get" action="spielplan.php" id="formSort" style="display: block;height: 50px;">    
...
<main>
    ...
    <form method="post" action="spielplan.php?sortieren=groupsort&sorting=Absenden">
        <div class="input-group">
